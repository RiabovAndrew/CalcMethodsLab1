...
class method_runge_kutta:
    ...
    def __fi_2(self, h):
        return h * self.function(self.combinate(self.x, h),
                                 self.combinate(self.y, -self.__fi_0(h) + 2 * self.__fi_1(h)))
...
tbl.add_row(
    ["\033[33m" + str(mrk.x) + "\033[0m", "\033[33m" + str(mrk.h) + "\033[0m", "\033[33m" + str(mrk.y) + "\033[0m"])
...
for element in table.X_I:
    tbl.add_row(["\033[33m" + str(element) + "\033[0m", "\033[33m" + str(table.Step_I[i]) + "\033[0m",
                 "\033[33m" + str(table.Y_I[i]) + "\033[0m"])
    i += 1
print(tbl)
tbl.clear_rows()
...
tbl.field_names = ["\033[36mX\033[0m", "\033[36mШаг\033[0m", "\033[36mНеточный Y\033[0m", "\033[36mТочный Y\033[0m",
                   "\033[36mПогрешность\033[0m"]
tbl.add_row(
    ["\033[33m" + str(x_0()) + "\033[0m", "\033[33m" + str(h()) + "\033[0m", "\033[33m" + str(y_0()) + "\033[0m",
     "\033[33m" + str(y_0()) + "\033[0m", "\033[33m" + str(0) + "\033[0m"])
for element in table.X_I:
    i = table.X_A.index(element)
    i2 = table.X_I.index(element)
    tbl.add_row(["\033[33m" + str(element) + "\033[0m", "\033[33m" + str(table.Step_I[i2]) + "\033[0m",
                 "\033[33m" + str(table.Y_I[i2]) + "\033[0m", "\033[33m" + str(table.Y_A[i]) + "\033[0m",
                 "\033[33m" + str(abs(table.Y_I[i2] - table.Y_A[i])) + "\033[0m"])
print(tbl)
tbl.clear_rows()
tbl = PrettyTable()
...
tbl.field_names = ["\033[36mX\033[0m", "\033[36mШаг\033[0m", "\033[36mНеточный Y\033[0m"]
tbl.add_row(
    ["\033[33m" + str(x_0()) + "\033[0m", "\033[33m" + str(0.2) + "\033[0m", "\033[33m" + str(y_0()) + "\033[0m"])
i = 0
for element in table.X_I:
    tbl.add_row(["\033[33m" + str(element) + "\033[0m", "\033[33m" + str(table.Step_I[i]) + "\033[0m",
                 "\033[33m" + str(table.Y_I[i]) + "\033[0m"])
